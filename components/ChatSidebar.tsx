                    ...
                    <div key={m.id} className={`flex flex-col gap-1 ${m.role === 'user' ? 'items-end' : 'items-start'}`}>
                        ...
                        {m.role === 'assistant' && (
                            <div className="pl-9 flex items-center gap-2">
                                ...
                                <button
                                    type="button"
                                    className="text-sm rounded-md px-3 py-1.5 bg-purple-600 text-white shadow-sm hover:bg-purple-700"
                                    onClick={() => {
                                        setSmartInsertContent(m.content)
                                        setShowSmartInserter(true)
                                    }}
                                >
                                    Smart Insert
                                </button>
