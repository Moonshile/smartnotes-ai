            ...
            <div className="sticky top-0 z-10 border-b bg-white/70 backdrop-blur">
                <div className="flex gap-2 items-center px-3 py-2 text-sm">
                    ...
                    <button
                        type="button"
                        title="生成文章大纲"
                        className="ml-2 px-3 py-1.5 rounded-md bg-green-600 text-white shadow-sm hover:bg-green-700"
          ...
          >
            智能处理
                    ...
                    <button
                        type="button"
                        title="检索相关资料"
                        className="ml-2 px-3 py-1.5 rounded-md bg-orange-600 text-white shadow-sm hover:bg-orange-700"
                        onClick={() => {
                            if (!editor) return
                            const sel = editor.state.selection
